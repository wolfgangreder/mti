...
public class NewContactWizardPanel1 implements WizardDescriptor.Panel<WizardDescriptor>, PropertyChangeListener
{
   ...
   */
  private NewContactVisualPanel1 component;
  ...
  {
    if (component == null) {
      component = new NewContactVisualPanel1();
  ...
  public void readSettings(WizardDescriptor settings)
  {
    ...
    component.setAllowedModes(tmpdata.getAllowedModes());
    component.setSelection(tmpdata.getCreationMode());
  }
