...
import at.or.reder.swing.model.EnumCheckboxModel;
...
public class EnumCheckbox<E extends Enum<E>> extends JPanel implements ErrorFlagable, Commitable
{
  ...
  private final class BoxActionListener implements ActionListener
  {
    ...
    private BoxActionListener(E value,
      ...
      if (values != null && !values.isEmpty()) {
        values.stream().
                ...
                forEach((e) -> {
                  ...
                  BoxActionListener boxListener = new BoxActionListener(e,
                                                                        box);
