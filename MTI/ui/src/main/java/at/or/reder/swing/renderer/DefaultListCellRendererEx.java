 ...
 */
public class DefaultListCellRendererEx<E> extends JLabel implements ListCellRenderer<E>
{
   ...
   */
  public DefaultListCellRendererEx()
  {
    super();
    setOpaque(true);
  ...
  protected Icon getIconValue(E value)
  {
