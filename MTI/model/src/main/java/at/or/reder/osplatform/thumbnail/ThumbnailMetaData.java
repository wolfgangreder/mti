...
/**
 * Thumbnail Metadata. See {@linkplain https://specifications.freedesktop.org/thumbnail-spec/thumbnail-spec-latest.html}.
 *
 * @author wolfi
 */
public interface ThumbnailMetaData
{
  ...
  public static final Set<String> META_NAMES = Collections.unmodifiableSet(new HashSet<>(Arrays.asList(THUMB_DESCRIPTION,
                                                                                                       THUMB_HEIGHT,
                                                                                                       THUMB_LENGTH,
                                                                                                       THUMB_MIMETYPE,
                                                                                                       THUMB_MTIME,
